...
meta-principles every stack builds on. Language-specific files refine these
with idioms, never contradict them.

> **Language note**: These are universal. A stack may show how a principle
